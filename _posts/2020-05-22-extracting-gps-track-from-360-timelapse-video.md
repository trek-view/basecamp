...
See our latest post titled; [Lessons Learned when Geotagging Photos, which includes considerations when working with fractional seconds](/blog/2021/lessons-learned-when-geotagging-photos).