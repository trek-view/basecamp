...
In total there are 17 GPS points `<trkpt>`'s. 1 for every second of the video.

[Interestingly in the metadata output](https://gitlab.com/snippets/1971839), there are about 18 GPS points recorded per second by the fusion. I _think_ this is due to the way exiftool handles the `gpmd` telemetry standard.
