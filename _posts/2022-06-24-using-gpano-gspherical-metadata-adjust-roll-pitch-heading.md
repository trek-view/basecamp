...
These images are problematic [if using a crude way to determine heading](/blog/what-direction-are-you-facing) (calculating the heading to the next photo, not the true heading of the camera).
